...
public class AppiumSetup
{
	...
	public void RunBeforeAnyTests()
	{
        ...
        androidOptions.AddAdditionalAppiumOption(AndroidMobileCapabilityType.AppPackage, "com.madetechbookclub.auctionsniper");

        //Make sure to set [Register("com.companyname.basicappiumsample.MainActivity")] on the MainActivity of your android application
		androidOptions.AddAdditionalAppiumOption(AndroidMobileCapabilityType.AppActivity, $"com.madetechbookclub.auctionsniper.MainActivity");
